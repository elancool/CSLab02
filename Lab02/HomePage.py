...
# INTRODUCTORY TEXT
st.write("""
This application is designed to collect and visualize data about how steps walked in a day correlates to one's energy level.
You can navigate to the different pages using the sidebar on the left.

### How to use this app:
- **Survey Page**: Go here to take my survey about steps walked and energy levels.
- **Visuals Page**: Go here to see the data from my survey visualized.
